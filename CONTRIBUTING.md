...
- **Windows checklist subset (non-flaky, PR-ready)** — `jwebgen --setup --dry-run`, `jwebgen --new myapp --yes`, `jwebgen --servlet`, `jwebgen --jsp`, `jwebgen --status` with fake `TOMCAT_HOME`.
